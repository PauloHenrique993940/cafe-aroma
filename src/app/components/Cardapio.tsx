...
export default function Cardapio() {
  ...
  const categorias: Record<string, ItemCardapio[]> = {
    cafes: [
    ...
    geladas: [
      ...
      { nome: 'Frappuccino', preco: 'R$ 12,00', imagem: 'https://parade.com/.image/ar_1:1%2Cc_fill%2Ccs_srgb%2Cfl_progressive%2Cq_auto:good%2Cw_1200/MjA5NjYwMzk1MTQzNTcwODc0/copycat-frappuccino-recipe.jpg' },
    ...
    salgados: [
      ...
      {nome:'Cochirra de Carne', preco:'R$ 7,50', imagem:'https://www.estadao.com.br/resizer/v2/Q7HKQKQW4RDTFMK7CR4ZZWTTTI.JPG?quality=80&auth=060f77d9ab978eace9c4b28ec294049d907aac5dbed5157f114eb18088799e0f&width=1075&height=527&focal=2436,1420'}
    ],
    doces: [
    ...
    <section id="cardapio">
      ...
      <div className="botoes-categorias">
        {botoes.map((btn) => (
          <button
            key={btn.id}
            className={categoriaAtiva === btn.id ? 'ativo' : ''}
            onClick={() => setCategoriaAtiva(btn.id)}
          >
            {btn.nome}
          </button>
        ))}
      ...
      <div className="categoria-conteudo">
        <h3>{botoes.find((b) => b.id === categoriaAtiva)?.nome}</h3>
        <div className="itens">
